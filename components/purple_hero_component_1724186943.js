        ...
        <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
            ...
            <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
                <div id="announcement-text" class="mb-6" data-aos="fade-down">
                    <div id="announcement-text-inner" class="flex relative before:absolute before:inset-0 before:blur-md before:bg-red-500">
                        <a id="announcement-link" class="flex-1 btn-sm py-0.5 transition duration-150 ease-in-out group relative before:absolute before:inset-0 before:rounded-full before:pointer-events-none shadow text-red-100 hover:text-white before:bg-red-800/50" 
                           href="#0" 
                           style="background: linear-gradient(theme(colors.red.500), theme(colors.red.500)) padding-box, linear-gradient(theme(colors.red.500), theme(colors.red.200) 75%, theme(colors.transparent) 100%) border-box;">
                            <span id="announcement-link-text" class="relative inline-flex items-center">
                                Swiftie Alert: Exclusive Taylor Swift Ticket Marketplace Now Live! 
                                <span id="announcement-arrow" class="tracking-normal group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1 text-red-300">-&gt;</span>
                            </span>
                        </a>
                    </div>
                </div>
